	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Increment') {
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Main$outbound(
					{ctor: '_Tuple0'})
			};
		}
	});
var _user$project$Main$SendValue = {ctor: 'SendValue'};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SendValue),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$jsMsgs(
		_elm_lang$core$Basics$always(_user$project$Main$Increment));
};
